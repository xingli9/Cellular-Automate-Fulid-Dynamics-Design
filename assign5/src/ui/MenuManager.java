...
public class MenuManager implements ActionListener {
	...
	private FDApp application = null;
	 ...
	 */
	public MenuManager(FDApp application) {
	 ...
	 */
	public MenuManager(FDApp application, String text) {
		this.application = application;
		this.text=text;
		this.id = "menu-" + Integer.toString(counter++);
		init();
	 ...
	 */
	public MenuManager(FDApp application, String text, String id) {
		this.application = application;
		this.text = text;
		this.id = id;
		init();
	...
	class ExitAction extends AbstractAction {
		...
		protected ExitAction(FDApp application) {
			super("ExitAction");
			this.application = application;
		}
	...
	class AboutAction extends AbstractAction {
		...
		protected AboutAction(FDApp application) {
			super("AboutAction");
			this.application = application;
		}
